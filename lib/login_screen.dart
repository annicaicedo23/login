...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _loginUser() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (mounted) {
        // 1. Validar si ni siquiera existe una cuenta registrada
        ...
        // 2. Validar si el correo ingresado no coincide con el registrado
        ...
        // 3. Validar si el correo es correcto pero la contraseña está mal
              ...
              child: Padding(
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      Icon(Icons.directions_bus, size: 60, color: Colors.blue.shade800),
